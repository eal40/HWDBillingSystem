...
#Region "Animation"
    ...
    Private Sub Timer_Tick(ByVal obj As Object, ByVal ea As EventArgs) Handles Timer1.Tick
        ...
        Dim fnt As New Font("Segoe UI", 90,
        ...
        Dim ptf_text_start As New PointF(
            CSng(ClientSize.Width - fnt_size.Width) / 2,
        ...
        Dim gradient_brush As New LinearGradientBrush(ptf_gradient_start,
...
#End Region
        ...
        Try
            ...
            Else
                sql = "INSERT INTO tblstaff (staff_id,staff_fname,staff_lname," &
                                            ...
                                            "staff_tell,staff_mobile,staff_fax,status,type) " &
    ...
    Private Sub lbladdcus_Click(sender As Object, e As EventArgs) Handles lbladdcus.Click

    End Sub

    Private Sub Pnl_AddCustomer_Paint(sender As Object, e As PaintEventArgs) Handles Pnl_AddCustomer.Paint
